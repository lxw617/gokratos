...
type StudentClient interface {
	...
	HelloStudent(ctx context.Context, in *HelloStudentRequest, opts ...grpc.CallOption) (*HelloStudentReply, error)
}
...
func (c *studentClient) HelloStudent(ctx context.Context, in *HelloStudentRequest, opts ...grpc.CallOption) (*HelloStudentReply, error) {
	out := new(HelloStudentReply)
	err := c.cc.Invoke(ctx, "/api.helloworld.v1.Student/HelloStudent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStudentServer) HelloStudent(context.Context, *HelloStudentRequest) (*HelloStudentReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HelloStudent not implemented")
}
...
func _Student_HelloStudent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloStudentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StudentServer).HelloStudent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.helloworld.v1.Student/HelloStudent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServer).HelloStudent(ctx, req.(*HelloStudentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Student_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HelloStudent",
			Handler:    _Student_HelloStudent_Handler,
		},
	},
